...
locals {
  state_machine_vars = {
    ...
    LAMBDA_COMPUTE_NETWORK_GRAPH     = aws_lambda_function.stub_handler.function_name
    LAMBDA_COMPUTE_LOBBYING_AGGREGATES = aws_lambda_function.stub_handler.function_name
