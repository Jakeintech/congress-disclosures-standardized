...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """Main Lambda handler (triggered by SQS) with smart retry logic.

    Implements exponential backoff and max retry limits to prevent DLQ flooding.
    ...
    Example event:
        {
            "Records": [
                {
                    "messageId": "...",
                    "body": "{\"entity_type\": \"member\", \"entity_id\": \"A000360\"}",
                    "attributes": {
