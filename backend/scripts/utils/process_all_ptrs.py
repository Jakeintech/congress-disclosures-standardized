#!/usr/bin/env python3
"""Process all PTRs locally through complete pipeline.

Run from repo root: python3 process_all_ptrs.py [limit]
"""
...
os.chdir('/Users/jake/Documents/GitHub/congress-disclosures-standardized')
...
print()
print('Next: Run generate_ptr_transactions.py to create full table')
