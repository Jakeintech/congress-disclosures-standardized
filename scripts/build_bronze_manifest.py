...
def main():
    ...
    for source_key in SOURCE_KEYS:
        try:
            print(f"📥 Trying source: {source_key}...")
            ...
            print(f"  ⚠️  {source_key} not found, trying next source...")
            continue
        except Exception as e:
            print(f"  ⚠️  Error reading {source_key}: {e}, trying next source...")
            continue
    
    # If no source found, create placeholder
    if manifest is None:
        print("⚠️  No source manifest found, creating placeholder...")
    ...
    print(f"✅ Bronze manifest created at API endpoint (source: {source_used})")
